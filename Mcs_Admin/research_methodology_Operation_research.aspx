<%@ Page Title="" Language="C#" MasterPageFile="~/Mcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="research_methodology_Operation_research.aspx.cs" Inherits="Learning_System.Mcs_Admin.research_methodology_Operation_research" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Research Methodology-Operation Research</h3>
        <hr />
