<%@ Page Title="" Language="C#" MasterPageFile="~/Mcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="seminar_in_emerging_issues_in_IT.aspx.cs" Inherits="Learning_System.Mcs_Admin.seminar_in_emerging_issues_in_IT" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Seminar in Emerging issue in IT</h3>
        <hr />
