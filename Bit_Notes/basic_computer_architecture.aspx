<%@ Page Title="Basic Computer Architecture - BIT Notes" Language="C#" MasterPageFile="~/Bit_Notes/note.Master" AutoEventWireup="true" CodeBehind="basic_computer_architecture.aspx.cs" Inherits="Learning_System.Bit_Notes.basic_computer_architecture" %>
    ...
    <div class="hero-card hero-card-compact fade-up d1">
      ...
      <div class="hero-row">
        ...
        <div class="hero-stats hero-stats-inline">
          <div class="stat-item"><span class="stat-val">BIT 116</span><span class="stat-lbl">Course Code</span></div>
      ...
      <div class="syl-preview">
        <div class="syl-doc-table">
          ...
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Course Code:</strong> BIT 6013</div>
          </div>
          <div class="syl-row-doc">
