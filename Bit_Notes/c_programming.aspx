<%@ Page Title="Computer Related Mathematics and Statistics - BIT Notes" Language="C#" MasterPageFile="~/Bit_Notes/note.Master" AutoEventWireup="true" CodeBehind="c_programming.aspx.cs" Inherits="Learning_System.Bit_Notes.c_programming" %>
...
<main class="main">
  <div class="main-inner">
    ...
    <div class="hero-card hero-card-compact fade-up d1">
      ...
      <div class="hero-row">
        <h1 class="hero-title hero-title-inline">Computer Related <span>Maths & Statistics</span></h1>
        <div class="hero-stats hero-stats-inline">
          <div class="stat-item"><span class="stat-val">BIT 115</span><span class="stat-lbl">Course Code</span></div>
          <div class="stat-item"><span class="stat-val">9</span><span class="stat-lbl">Topics</span></div>
    ...
    <div class="fade-up d2">
      ...
      <div class="files-card" id="panelPapers" style="display:none;">
        <div class="empty-state">
          ...
          <div class="empty-text">Past year question papers for Computer Related Maths & Statistics will be added once available from the teacher.</div>
        </div>
      </div>
    </div>
...
<div class="syl-modal-bg" id="sylModal">
  <div class="syl-modal">
    <div class="syl-modal-header">
      <span class="syl-modal-title">📋 Computer Related Mathematics and Statistics — Course Syllabus (BIT 115)</span>
      ...
      <div class="syl-preview">
        <div class="syl-doc-table">
          ...
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Course Name:</strong> Computer Related Mathematics and Statistics</div>
          </div>
          <div class="syl-row-doc">
            <div class="syl-num">2</div>
            <div class="syl-cell"><strong>Course Code:</strong> BIT 115</div>
          </div>
          <div class="syl-row-doc">
          ...
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Synopsis:</strong> This course covers the mathematical and statistical foundations required for computer science, including logic, algebra, and probability.</div>
          </div>
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Content Outline:</strong>
              <table class="syl-inner-table syl-topics-table">
                ...
                <tbody>
                  <tr><td>1</td><td><strong>Number Systems</strong><ul><li>Binary, octal, hexadecimal</li><li>Conversion between bases</li><li>Arithmetic operations</li></ul></td></tr>
                  <tr><td>2</td><td><strong>Boolean Algebra</strong><ul><li>Logic gates</li><li>Boolean expressions</li><li>Simplification techniques</li></ul></td></tr>
                  <tr><td>3</td><td><strong>Set Theory</strong><ul><li>Sets, subsets, power sets</li><li>Union, intersection, complement</li><li>Venn diagrams</li></ul></td></tr>
                  <tr><td>4</td><td><strong>Relations &amp; Functions</strong><ul><li>Types of relations</li><li>Functions and mappings</li><li>Composition of functions</li></ul></td></tr>
                  <tr><td>5</td><td><strong>Matrices &amp; Determinants</strong><ul><li>Matrix operations</li><li>Determinants</li><li>Matrix inverse</li></ul></td></tr>
                  <tr><td>6</td><td><strong>Probability</strong><ul><li>Basic probability rules</li><li>Conditional probability</li><li>Bayes theorem</li></ul></td></tr>
                  <tr><td>7</td><td><strong>Statistics</strong><ul><li>Mean, median, mode</li><li>Variance and standard deviation</li><li>Frequency distributions</li></ul></td></tr>
                  <tr><td>8</td><td><strong>Graph Theory</strong><ul><li>Graphs and trees</li><li>Paths and cycles</li><li>Spanning trees</li></ul></td></tr>
                  <tr><td>9</td><td><strong>Combinatorics</strong><ul><li>Permutations and combinations</li><li>Counting principles</li><li>Pigeonhole principle</li></ul></td></tr>
                </tbody>
              </table></div>
          </div>
        </div>
...
<script>
  function switchTab(tab) {
    ...
    document.getElementById('panelPapers').style.display = tab === 'papers' ? '' : 'none';
