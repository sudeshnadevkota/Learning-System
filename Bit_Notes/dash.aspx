  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .cc-icon {
      ...
      .cc-icon.bcs {
        background: rgba(255,45,141,0.09);
      }
    ...
    .cc-cta {
      ...
      .cc-cta:hover {
        background: var(--pink);
        box-shadow: 0 4px 16px rgba(255,45,141,0.4);
        transform: translateY(-1px);
      }

    .course-card.selected .cc-cta {
      background: var(--pink);
      box-shadow: 0 4px 16px rgba(255,45,141,0.35);
    }
    ...
    @media (max-width: 991px) {
      ...
      #content {
        width: 100% !important;
        margin-left: 0 !important; /* Removes the 300px desktop gap */
            ...
            <div class="poster-card">
              <div class="poster-inner">
                ...
                <div class="poster-degree-sub">Bachelor of (Hons.) in<br>
                  <strong>Information Technology</strong></div>
