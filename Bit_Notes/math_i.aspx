<%@ Page Title="Principles of Information Technology - BIT Notes" Language="C#" MasterPageFile="~/Bit_Notes/note.Master" AutoEventWireup="true" CodeBehind="math_i.aspx.cs" Inherits="Learning_System.Bit_Notes.math_i" %>
    ...
    <div class="hero-card hero-card-compact fade-up d1">
      ...
      <div class="hero-row">
        ...
        <div class="hero-stats hero-stats-inline">
          <div class="stat-item"><span class="stat-val">BIT 111</span><span class="stat-lbl">Course Code</span></div>
...
<div class="syl-modal-bg" id="sylModal">
  <div class="syl-modal">
    <div class="syl-modal-header">
      <span class="syl-modal-title">📋 Principles of Information Technology — Course Syllabus (BIT 111)</span>
      ...
      <div class="syl-preview">
        <div class="syl-doc-table">
          ...
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Course Name:</strong> Principles of Information Technology</div>
          </div>
          <div class="syl-row-doc">
            <div class="syl-num">2</div>
            <div class="syl-cell"><strong>Course Code:</strong> BIT 111</div>
          </div>
          <div class="syl-row-doc">
          ...
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Synopsis:</strong> This course provides a broad introduction to the field of information technology, covering the core concepts students will build upon throughout their degree.</div>
          </div>
          <div class="syl-row-doc">
            ...
            <div class="syl-cell"><strong>Content Outline:</strong>
              <table class="syl-inner-table syl-topics-table">
                ...
                <tbody>
                  <tr><td>1</td><td><strong>Introduction to IT</strong><ul><li>History of computing</li><li>Role of IT in society</li><li>IT careers and trends</li></ul></td></tr>
                  <tr><td>2</td><td><strong>Computer Hardware</strong><ul><li>CPU, memory, storage</li><li>Input/output devices</li><li>System architecture</li></ul></td></tr>
                  <tr><td>3</td><td><strong>Operating Systems</strong><ul><li>Functions of OS</li><li>Types: Windows, Linux, macOS</li><li>File management</li></ul></td></tr>
                  <tr><td>4</td><td><strong>Software Concepts</strong><ul><li>System vs application software</li><li>Software development lifecycle</li><li>Open source software</li></ul></td></tr>
                  <tr><td>5</td><td><strong>Networking Basics</strong><ul><li>LAN, WAN, Internet</li><li>Network topologies</li><li>IP addressing basics</li></ul></td></tr>
                  <tr><td>6</td><td><strong>Data &amp; Information</strong><ul><li>Data types and formats</li><li>Database concepts</li><li>Data security basics</li></ul></td></tr>
                  <tr><td>7</td><td><strong>Internet &amp; Web</strong><ul><li>How the Internet works</li><li>Web browsers and servers</li><li>Email and cloud services</li></ul></td></tr>
                  <tr><td>8</td><td><strong>Emerging Technologies</strong><ul><li>AI and machine learning</li><li>IoT and robotics</li><li>Cybersecurity overview</li></ul></td></tr>
                </tbody>
              </table></div>
          </div>
        </div>
