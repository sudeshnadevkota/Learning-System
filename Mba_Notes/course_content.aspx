            ...
            <div class="hero-card hero-card-compact fade-up d1">
                ...
                <div class="hero-row">
                    ...
                    <div class="hero-stats hero-stats-inline">
                        <div class="stat-item">
                            <span class="stat-val">
                                <asp:Literal ID="litDisplayCode" runat="server" /></span><span class="stat-lbl">Course Code</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-val">
                                <asp:Literal ID="litCredits" runat="server" /></span><span class="stat-lbl">Credits</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-val">
                                <asp:Literal ID="litHours" runat="server" /></span><span class="stat-lbl">Total hrs</span>
                        </div>
                    </div>
                </div>
