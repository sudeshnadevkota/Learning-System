    ...
    public partial class BIT_5_2017 : System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Name, Data, ContentType FROM BIT_5_2017 WHERE Id = @Id", con))
                    {
            ...
            catch (Exception ex)
            {
                ...
                // Use a logging framework or custom error handling here
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Id, Name, Topic FROM BIT_5_2017", con))
                {
                    con.Open();
