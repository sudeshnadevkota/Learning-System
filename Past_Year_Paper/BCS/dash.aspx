<%@ Page Title="" Language="C#" MasterPageFile="~/Past_Year_Paper/BCS/BCS.Master" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="Learning_System.Past_Year_Paper.BCS.dash" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container " style="padding-top:3px;">
       ...
       <img src="../../slide/bcs3.png" class="img-fluid w-100" style="height: 350px; border-radius: 10px; object-fit: cover" />
   </div>
