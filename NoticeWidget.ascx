<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NoticeWidget.ascx.cs" Inherits="Learning_System.NoticeWidget" %>

<div class="notice-widget">
  <div class="notice-widget-head">
    <h3>📋 Recent Notices</h3>
    <a href="<%= ResolveUrl("~/Notices.aspx") %>">View All</a>
  </div>

  <asp:Repeater ID="rptWidget" runat="server">
    <ItemTemplate>
      <div class="notice-widget-item" onclick="location.href='<%# ResolveUrl("~/Notices.aspx") %>'">
        <div>
