        ...
        *, *::before, *::after {
        ...
        .btn-learn {
            ...
            .btn-learn:hover {
                ...
                color: white;
                transform: translateY(-2px);
                box-shadow: 0 8px 24px rgba(255,45,141,0.4);
            }
          ...
          <div class="hms-item">
            ...
            <div class="about-section fade-up d2" id="coursesSection">
                <div class="about-left">
                    ...
                    <p class="about-para">
                        The <strong>Bachelor of Hotel Management (BHM)</strong> at Texas College of Management and IT (TCMIT), affiliated with <strong>Lincoln University College, Malaysia</strong>, is a 4-year, 8-semester program that blends hospitality theory with practical execution through modern labs, live projects, and industry internships.
                    </p>
                    <ul class="about-bullets">
                        <li><strong>Semester 1–2:</strong> Front Office Operations & Housekeeping Management.</li>
                        <li><strong>Semester 3–4:</strong> Food & Beverage Management & Culinary Training.</li>
                        <li><strong>Semester 5:</strong> Event Management & Tourism Studies.</li>
                        <li><strong>Semester 6:</strong> Hotel Marketing & Revenue Management.</li>
                        <li><strong>Certifications:</strong> Certified Hospitality Supervisor (CHS) & GDS Training.</li>
                        <li><strong>Practical Labs:</strong> Training Kitchen, Mock Front Desk & Restaurant Bar Lab.</li>
                        <li><strong>Industry Exposure:</strong> Live Projects & Hotel Internships.</li>
                        <li><strong>Resources:</strong> e-Library & Hotel Technology Systems.</li>
                    </ul>
                        ...
                        <div class="poster-card">
                            <div class="poster-inner">
                                ...
                                <div class="poster-degree-sub">Bachelor of (Hons.) in<br>
                                    <strong>Hotel Management</strong></div>

                                <div class="poster-why-box">
                                    <div class="pwb-title">Discover <span>BHM</span><br>
                                        at Texas</div>
