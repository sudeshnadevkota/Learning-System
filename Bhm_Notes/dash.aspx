<%@ Page Title="" Language="C#" MasterPageFile="~/Bhm_Notes/note.Master" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="Learning_System.Bhm_Notes.dash" ResponseEncoding="utf-8" %>
  ...
  <div class="main-inner">
    ...
    <div class="hero-banner fade-up d1">
      ...
      <div class="hero-visual">
        <div class="hero-illustration">
          ...
          <!-- SVG Student Illustration (BHM — hotel/hospitality theme) -->
          <svg class="student-fig" viewBox="0 0 240 280" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- bow tie -->
            <polygon points="120,162 113,168 120,174 127,168" fill="#FF2D8D"/>
            <!-- jacket lapels -->
            ...
            <!-- serving tray held in right hand -->
            <ellipse cx="196" cy="232" rx="28" ry="6" fill="#d4af37" opacity="0.9"/>
            <ellipse cx="196" cy="230" rx="24" ry="4" fill="#f5c542"/>
            <!-- cloche / dome on tray -->
            <ellipse cx="196" cy="228" rx="16" ry="3" fill="#e8e8e8"/>
            <path d="M180 228 Q180 210 196 208 Q212 210 212 228Z" fill="#f0f0f0"/>
            <ellipse cx="196" cy="208" rx="3" ry="2" fill="#d4af37"/>
            <!-- neck -->
            ...
            <rect x="66" y="218" width="26" height="34" rx="3" fill="#fff8e7" stroke="#d4af37" stroke-width="1.5"/>
            <rect x="70" y="224" width="18" height="2" rx="1" fill="#d4af37" opacity="0.6"/>
            <rect x="70" y="229" width="14" height="2" rx="1" fill="#d4af37" opacity="0.5"/>
            <rect x="70" y="234" width="16" height="2" rx="1" fill="#d4af37" opacity="0.4"/>
            <rect x="70" y="239" width="12" height="2" rx="1" fill="#d4af37" opacity="0.3"/>
          </svg>
          ...
          <div class="ilu-badge ib-1">
            ...
            <div class="ib-txt">
              ...
              <span>Live kitchen & front desk</span>
            </div>
          </div>
    ...
    <div class="about-section fade-up d2" id="coursesSection">
      <div class="about-left">
        ...
        <h2 class="about-heading">Nepal's Premier <span>BHM Degree</span></h2>

        <p class="about-para">
          The <strong>Bachelor of Hotel Management (BHM)</strong> at Texas College of Management and IT (TCMIT) is a 4-year, 8-semester program affiliated with <strong>Lincoln University College, Malaysia</strong>.
          Designed to blend hospitality theory with practical execution, the program covers front office operations, food & beverage management, housekeeping, event management, tourism, and hotel marketing.
          With modern facilities including a fully equipped Training Kitchen, Mock Hotel Front Desk, and Restaurant & Bar Lab, students gain hands-on experience to graduate completely career-ready.
        </p>
        <p class="about-para">
          ...
          With dedicated F&amp;B and Front Office labs, an Incubation Center, and a state-of-the-art e-library, students gain hands-on experience managing real-world hospitality operations.
          Industry training, live project work, and globally recognised certifications ensure graduates are career-ready for hotel management roles in Nepal and around the world.
        </p>
        <p class="about-para">
          Alongside this core hospitality track, the student journey includes specialized professional training to make them globally competitive.
          Students engage in Certified Hospitality Supervisor (CHS) preparation, Revenue &amp; Property Management System workshops, event planning simulations, and cross-cultural communication training.
          Finally, they achieve production-ready expertise in Hotel Technology Systems and Global Distribution Systems (GDS).
        </p>
          ...
          <div class="poster-card">
            <div class="poster-inner">
              ...
              <div class="poster-degree-row">
                <div class="poster-degree-title">BHM</div>
              </div>
              <div class="poster-degree-sub">Bachelor of (Hons.) in<br><strong>Hotel Management</strong></div>

              <div class="poster-why-box">
                <div class="pwb-title">Discover <span>BHM</span><br>at Texas</div>
                <div class="pwb-item">▶ 5-Star Training Hotel Lab</div>
                <div class="pwb-item">▶ F&amp;B Production Kitchen</div>
                <div class="pwb-item">▶ Mock Front Desk Studio</div>
                <div class="pwb-item">▶ Resourceful Library &amp; ebrary</div>
                <div class="pwb-item">▶ Hospitality Incubation Center</div>
              </div>
              ...
              <div class="poster-student">
                <svg viewBox="0 0 160 270" fill="none" xmlns="http://www.w3.org/2000/svg" width="155" height="270">
                  ...
                  <!-- bow tie -->
                  <polygon points="80,131 74,136 80,141 86,136" fill="#FF2D8D"/>
                  ...
                  <!-- tray in right hand -->
                  <ellipse cx="138" cy="200" rx="22" ry="5" fill="#d4af37" opacity="0.9"/>
                  <ellipse cx="138" cy="198" rx="18" ry="3.5" fill="#f5c542"/>
                  <path d="M120 198 Q120 183 138 181 Q156 183 156 198Z" fill="#f0f0f0"/>
                  <ellipse cx="138" cy="181" rx="2.5" ry="1.5" fill="#d4af37"/>
                  <!-- notepad left hand -->
                  <rect x="18" y="202" width="22" height="28" rx="3" fill="#fff8e7" stroke="#d4af37" stroke-width="1.5"/>
                  <rect x="22" y="208" width="14" height="2" rx="1" fill="#d4af37" opacity="0.6"/>
                  <rect x="22" y="213" width="10" height="2" rx="1" fill="#d4af37" opacity="0.5"/>
                  <rect x="22" y="218" width="12" height="2" rx="1" fill="#d4af37" opacity="0.4"/>
                  ...
                  <!-- hotel hat -->
                  <rect x="54" y="44" width="52" height="14" rx="3" fill="white"/>
                  <rect x="60" y="30" width="40" height="18" rx="6" fill="white"/>
                  <rect x="54" y="42" width="52" height="5" rx="2" fill="#e8e8e8"/>
...
<script>
const semesterData = [
    { label: "First Sem", icon: "1️⃣", subjects: ["Foundations of Hospitality", "Hotel Operations", "Food & Beverage I", "Communication Skills", "Business Maths"] },
    { label: "Second Sem", icon: "2️⃣", subjects: ["Front Office Management", "Housekeeping Management", "F&B Service II", "Principles of Tourism", "Accounting for Hotels"] },
    { label: "Third Sem", icon: "3️⃣", subjects: ["Hotel Marketing", "Revenue Management", "Culinary Arts I", "Event Management", "Human Resource Management"] },
    { label: "Fourth Sem", icon: "4️⃣", subjects: ["Hotel Financial Management", "Culinary Arts II", "Rooms Division Management", "Travel & Tourism Management", "Strategic Management"] },
    { label: "Fifth Sem", icon: "5️⃣", subjects: ["Resort & Spa Management", "Food Safety & Hygiene", "Digital Marketing for Hotels", "Convention & MICE", "Property Management Systems"] },
    { label: "Sixth Sem", icon: "6️⃣", subjects: ["Hospitality Law & Ethics", "Global Distribution Systems", "Sustainable Tourism", "Entrepreneurship", "Research Methods"] },
    { label: "Seventh Sem", icon: "7️⃣", subjects: ["Capstone Project", "Internship", "Elective I", "Elective II", "Advanced Hospitality Topics"] },
