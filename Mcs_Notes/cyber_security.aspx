<%@ Page Title="" Language="C#" MasterPageFile="~/Mcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="cyber_security.aspx.cs" Inherits="Learning_System.Mcs_Notes.cyber_security" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- Wrap the GridView in a table-responsive div for responsiveness -->
