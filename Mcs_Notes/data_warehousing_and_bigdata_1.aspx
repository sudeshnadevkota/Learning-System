<%@ Page Title="" Language="C#" MasterPageFile="~/Mcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="data_warehousing_and_bigdata_1.aspx.cs" Inherits="Learning_System.Mcs_Notes.data_warehousing_and_bigdata_1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- Wrap GridView with table-responsive to make it responsive -->
