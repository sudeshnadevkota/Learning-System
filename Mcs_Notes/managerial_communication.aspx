<%@ Page Title="" Language="C#" MasterPageFile="~/Mcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="managerial_communication.aspx.cs" Inherits="Learning_System.Mcs_Notes.managerial_communication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- Wrap GridView with table-responsive for responsiveness -->
