<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="business_finance.aspx.cs" Inherits="Learning_System.Bba_Admin.business_finance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Business Finance</h3>
        <hr />
