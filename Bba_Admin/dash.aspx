<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="Learning_System.Bba_Admin.dash" %>
...
<div class="d-wrap container-fluid" style="padding: 1.5rem;">
    ...
    <div class="d-hero">
        ...
        <h1>Welcome to BBA Upload Section</h1>
        ...
        <div class="d-hero-stats">
            ...
            <div class="d-hstat">
                <span class="d-hstat-val">34</span>
    ...
    <div class="d-cards">
        ...
        <div class="d-card card-pink">
            ...
            <p class="d-card-text">Manage your primary features and core settings for BBA faculty.</p>
        ...
        <div class="d-card card-blue">
            <div class="d-card-top-bar"></div>
            <div class="d-card-icon">
                <div class="d-card-icon-inner"><i class="ti ti-chart-pie"></i></div>
            </div>
        ...
        <div class="d-card card-yellow">
            ...
            <p class="d-card-text">This week's highlighted module for BBA students.</p>
            <div class="d-card-foot">
                <a href="#" class="d-go"><i class="ti ti-arrow-right"></i> Go More</a>
                <span class="d-badge-status">Active</span>
            </div>
    ...
    <div class="d-feature">
        ...
        <div class="d-feature-body">
            ...
            <p class="d-feature-text">
                ...
                This is your highlighted module for the week — tailored for BBA students in Business Administration faculty.
            </p>
