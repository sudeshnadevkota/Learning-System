<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="bachelor_thesis_on_internship(mar).aspx.cs" Inherits="Learning_System.Bba_Admin.bachelor_thesis_on_internship_mar_" %>
    ...
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
        ...
        <asp:Label ID="lblMessage" Text="" runat="server" />
         ...
         <div class="container">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" class="table table-bordered table-condensed table-responsive table-hover" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting1">          <Columns>
