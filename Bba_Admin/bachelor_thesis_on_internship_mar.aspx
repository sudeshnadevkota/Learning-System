<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="bachelor_thesis_on_internship_mar.aspx.cs" Inherits="Learning_System.Bba_Admin.bachelor_thesis_on_internship_mar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
        <h3 style="text-align: center">Bachelor Thesis on Internship (Mar)</h3>
        <hr />
        ...
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Submit" Style="margin-top: 10px; float:right; margin-bottom: 10px; height:35px; font-size:18px;" OnClick="Button1_Click" />
        
        <asp:Label ID="lblMessage" runat="server" />

        <div class="container">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" CssClass="table table-bordered table-condensed table-responsive table-hover" OnRowUpdating="GridView1_RowUpdating1" OnRowDeleting="GridView1_RowDeleting1" OnRowEditing="GridView1_RowEditing1" OnRowCancelingEdit="GridView1_RowCancelingEdit1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Data Type">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("ContentType") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
