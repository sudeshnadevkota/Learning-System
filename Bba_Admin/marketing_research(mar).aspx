<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="marketing_research(mar).aspx.cs" Inherits="Learning_System.Bba_Admin.marketing_research_mar_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Marketing Research</h3>
        <hr />
