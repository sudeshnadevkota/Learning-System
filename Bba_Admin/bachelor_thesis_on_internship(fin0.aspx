<%@ Page Title="" Language="C#" MasterPageFile="~/Bba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="bachelor_thesis_on_internship(fin0.aspx.cs" Inherits="Learning_System.Bba_Admin.bachelor_thesis_on_internship_fin0" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Bachelor Thesis on Internship(fin0</h3>
        <hr />
