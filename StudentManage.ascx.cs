...
{
    public partial class StudentManageControl : System.Web.UI.UserControl, IDynamicSection
    {
        ...
        {
            // Controls do not pass 'this' if the helper expects a Page type instance object.
        ...
        // Save, etc.), where state should persist via ViewState and the
        // relevant handler (e.g. btnSaveEdit_Click) reloads data itself.
