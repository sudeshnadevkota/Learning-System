<%@ Page Title="Super Admin Dashboard" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdmin.master" AutoEventWireup="true" CodeBehind="Dash.aspx.cs" Inherits="Learning_System.SuperAdmin.Dash" %>
<%@ MasterType VirtualPath="~/SuperAdmin/SuperAdmin.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="c-topbar c-fade-up"> 
        <div>
            <h1><i class="ti ti-shield-star"></i> Super Admin Dashboard</h1>
            <p>Logged in as <strong><%= Session["Username"] %></strong> &middot; Department-wide access</p>
        </div>
