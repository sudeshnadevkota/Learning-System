<%@ Page Title="Manage Departments" Language="C#" AutoEventWireup="true" CodeBehind="DepartmentManage.aspx.cs" Inherits="Learning_System.SuperAdmin.DepartmentManage" %>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
            ...
            /* Single page heading, reused on both mobile and desktop */
            .c-topbar { margin-bottom: 14px; }
            .c-topbar h1 { font-size: 1.2rem; letter-spacing: -0.2px; }
            .c-topbar p { font-size: 12px; }

            /* The ghost "Back to Dashboard" button is redundant with the
               back arrow already in the mobile top bar, so hide it here */
        ...
        <div class="c-shell">
            ...
            <aside class="c-sidebar">
                ...
                <nav class="c-nav">
                    ...
                    <a href="DepartmentManage.aspx" class="c-nav-link active"><i class="ti ti-building"></i> Departments</a>
