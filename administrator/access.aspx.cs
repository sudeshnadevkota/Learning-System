...
namespace Learning_System.administrator
{
    public partial class access : System.Web.UI.Page
    {
        ...
        {
            string query = "SELECT * FROM login_";
        ...
        private void BindRepeater(string searchQuery)
        {
            ...
            {
                query += " WHERE Username LIKE @SearchQuery OR role LIKE @SearchQuery OR full_name LIKE @SearchQuery OR contact LIKE @SearchQuery OR status LIKE @SearchQuery";
            }
