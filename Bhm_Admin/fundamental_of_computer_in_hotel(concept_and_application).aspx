<%@ Page Title="" Language="C#" MasterPageFile="~/Bhm_Admin/upload.Master" AutoEventWireup="true" CodeBehind="fundamental_of_computer_in_hotel(concept_and_application).aspx.cs" Inherits="Learning_System.Bhm_Admin.fundamental_of_computer_in_hotel_concept_and_application_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Fundamental of Computer in Hotel(concept_and_application)</h3>
        <hr />
