<%@ Page Title="" Language="C#" MasterPageFile="~/Bhm_Admin/upload.Master" AutoEventWireup="true" CodeBehind="hotel_maintenance.aspx.cs" Inherits="Learning_System.Bhm_Admin.hotel_maintenance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Hotel Maintenance</h3>
        <hr />
