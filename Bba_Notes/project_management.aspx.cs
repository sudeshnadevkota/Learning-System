    ...
    public partial class project_management : System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    cmd.CommandText = "select id,Topic, Name, Data, ContentType from bba_projectmanagement where Id=@Id";
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select Id,Topic, Name from bba_projectmanagement";
                    cmd.Connection = con;
                    con.Open();
