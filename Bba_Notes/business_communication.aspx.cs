...
{
    public partial class business_communication : System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    cmd.CommandText = "select id,Topic, Name, Data, ContentType from bba_bc where Id=@Id";
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select Id,Topic, Name from bba_bc";
                    cmd.Connection = con;
                    con.Open();
