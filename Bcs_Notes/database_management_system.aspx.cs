    ...
    public partial class database_management_system : System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    cmd.CommandText = "SELECT id, Topic, Name, Data, ContentType FROM bcs_dms WHERE Id=@Id";
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "SELECT Id, Topic, Name FROM bcs_dms";
                    cmd.Connection = con;
                    con.Open();
        ...
        {
            // Redirect to the dashboard page or another page
