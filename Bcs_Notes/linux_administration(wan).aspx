<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="linux_administration(wan).aspx.cs" Inherits="Learning_System.Bcs_Notes.linux_administration_wan_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- GridView for displaying Linux Administration WAN documents -->
