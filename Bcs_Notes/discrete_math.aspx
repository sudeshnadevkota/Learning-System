<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="discrete_math.aspx.cs" Inherits="Learning_System.Bcs_Notes.discrete_math" %>
...
<main class="main">
  <div class="main-inner">
    ...
    <div class="hero-card hero-card-compact fade-up d1">
      ...
      <div class="hero-row">
        <h1 class="hero-title hero-title-inline">Discrete Mathematics <span>& Probability</span></h1>
        <div class="hero-stats hero-stats-inline">
          <div class="stat-item"><span class="stat-val">BCSNT 6023</span><span class="stat-lbl">Course Code</span></div>
