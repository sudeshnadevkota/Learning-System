<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="security_in_computing.aspx.cs" Inherits="Learning_System.Bcs_Notes.security_in_computing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- GridView for displaying Security in Computing documents -->
