...
{
    public partial class CluoudComputing : System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    cmd.CommandText = "select id,Topic, Name, Data, ContentType from bcs_cc where Id=@Id";
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select Id,Topic, Name from bcs_cc";
                    cmd.Connection = con;
                    con.Open();
