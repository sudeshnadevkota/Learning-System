<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="principle_of_programming.aspx.cs" Inherits="Learning_System.Bcs_Notes.principle_of_programming" %><asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* stats */
  .hero-stats { display: flex; gap: 0; margin-bottom: 30px; max-width: 540px; }
  .stat-item {
  ...
  .stat-val { font-family: 'Sora', sans-serif; font-size: 26px; font-weight: 800; color: white; }
  .stat-lbl { font-size: 10px; font-weight: 600; color: rgba(255,255,255,0.4); text-transform: uppercase; letter-spacing: 0.8px; }
  ...
  .progress-track { height: 6px; background: rgba(255,255,255,0.1); border-radius: 3px; position: relative; }
  .progress-fill { height: 100%; width: 35%; background: linear-gradient(90deg, var(--pink), #ff6bb0); border-radius: 3px; }
  .progress-thumb {
  ...
  /* ══ QUICK STATS ROW ══ */
  .stats-row { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 28px; width: 100%; }
  ...
  .learn-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 28px; }
  ...
  .lc-text h4 { font-family: 'Sora', sans-serif; font-size: 13px; font-weight: 600; color: var(--primary); margin-bottom: 4px; }
  ...
  .syl-modal-body { flex: 1; overflow-y: auto; padding: 0; }
  ...
  .syl-preview h3 {
    ...
    letter-spacing: 0.8px; margin: 20px 0 6px;
  }
  .syl-preview p { margin: 0 0 8px; }
  .syl-preview .syl-row { display: flex; gap: 8px; padding: 8px 0; border-bottom: 1px solid var(--border); }
  .syl-preview .syl-row:last-child { border-bottom: none; }
  .syl-preview .syl-row-label { font-weight: 600; min-width: 120px; color: var(--text-secondary); font-size: 12.5px; }
  ...
  .syl-row-doc {
    display: flex; border-bottom: 1px solid #e5e9f2;
    font-size: 13.5px; line-height: 1.65; color: #1a2a5e;
  }
  ...
  .syl-inner-table td {
    padding: 8px 10px; border: 1px solid #e0e5f0; vertical-align: top;
  }
  ...
  .syl-total-row td {
    background: #f0f3fc; font-weight: 700; color: #0B1F66;
  }
  ...
  .ctab-btn.active { background: var(--pink); color: #fff; box-shadow: 0 3px 12px var(--pink-glow); }
  ...
  .empty-title { font-family: 'Sora', sans-serif; font-size: 15px; font-weight: 700; color: var(--text-primary); }
  .empty-text { font-size: 13px; color: var(--text-secondary); max-width: 340px; line-height: 1.6; }
...
<main class="main">
  <div class="main-inner">
    ...
    <div class="hero-card hero-card-compact fade-up d1">
      ...
      <div class="hero-row">
        <h1 class="hero-title hero-title-inline">Principle of <span>Programming</span></h1>
        <div class="hero-stats hero-stats-inline">
          <div class="stat-item"><span class="stat-val">BCSNT 6013</span><span class="stat-lbl">Course Code</span></div>
    ...
    <div class="fade-up d2">
      ...
      <div class="files-card" id="panelPapers" style="display:none;">
        <%--
          FUTURE: Replace with a real GridView bound to past papers data.
          Example:
...
function switchTab(tab) {
    ...
    if (!panelNotes || !panelPapers || !tabNotes || !tabPapers) return;
