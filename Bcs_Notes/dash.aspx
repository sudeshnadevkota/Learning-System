<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Notes/note.Master" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="Learning_System.Bcs_Notes.dash" ResponseEncoding="utf-8" %>
          ...
          <div class="hms-item">
                ...
                <div class="hero-visual">
                    <div class="hero-illustration">
                        ...
                        <svg class="student-fig" viewBox="0 0 240 280" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- shield held in right hand -->
                            <path d="M192 205 Q192 185 210 180 Q228 185 228 205 Q228 225 210 232 Q192 225 192 205Z" fill="#0B1F66" stroke="#FF2D8D" stroke-width="2" />
                            <path d="M198 205 Q198 190 210 186 Q222 190 222 205 Q222 220 210 226 Q198 220 198 205Z" fill="#162077" />
                            <!-- lock icon on shield -->
                            <rect x="205" y="203" width="10" height="9" rx="2" fill="#F5C542" />
                            <path d="M206 203 Q206 197 210 197 Q214 197 214 203" stroke="#F5C542" stroke-width="2" fill="none" />
                            <circle cx="210" cy="207" r="1.5" fill="#0B1F66" />
                            <!-- neck -->
                            ...
                            <rect x="84" y="214" width="14" height="2" rx="1" fill="#4ade80" opacity="0.9" />
                            <rect x="100" y="214" width="36" height="2" rx="1" fill="#60a5fa" opacity="0.7" />
                            <rect x="84" y="219" width="24" height="2" rx="1" fill="#FF2D8D" opacity="0.8" />
                            <rect x="110" y="219" width="28" height="2" rx="1" fill="#fbbf24" opacity="0.7" />
                            <rect x="84" y="224" width="44" height="2" rx="1" fill="#4ade80" opacity="0.6" />
                            <rect x="84" y="229" width="18" height="2" rx="1" fill="#a78bfa" opacity="0.7" />
                        </svg>

                        <!-- Floating badges — BCS specific -->
                        <div class="ilu-badge ib-1">
                            <div class="ib-icon blue">🛡️</div>
                            <div class="ib-txt">
                                <strong>CEH Certified Lab</strong>
                                <span>Ethical hacking practice</span>
                            </div>
                        </div>
                        ...
                        <div class="ilu-badge ib-2">
                            ...
                            <div class="ib-txt">
                                ...
                                <span>Digital forensics tools</span>
                            </div>
                        </div>
            ...
            <div class="about-section fade-up d2" id="coursesSection">
                <div class="about-left">
                    ...
                    <p class="about-para">
                        The <strong>Bachelor of Computer Science (BCS)</strong> at Texas College of Management and IT (TCMIT), affiliated with <strong>Lincoln University College, Malaysia</strong>, builds strong programming and computing foundations through hands-on learning, modern labs, and real-world projects.
                    </p>
                    <ul class="about-bullets">
                        <li><strong>Semester 1:</strong> Programming Fundamentals & Discrete Mathematics.</li>
                        <li><strong>Semester 2:</strong> Object-Oriented Programming & Data Structures.</li>
                        <li><strong>Semester 3–4:</strong> Algorithms, Database Systems & Operating Systems.</li>
                        <li><strong>Semester 5:</strong> Computer Networks & Software Engineering.</li>
                        <li><strong>Semester 6+:</strong> Artificial Intelligence & Machine Learning.</li>
                        <li><strong>Certifications:</strong> Cisco, Cloud Computing & Data Science.</li>
                        <li><strong>Systems Programming:</strong> Linux, C/C++ & System Architecture.</li>
                        <li><strong>Cybersecurity:</strong> Network Security Essentials.</li>
                    </ul>
                        ...
                        <div class="poster-card">
                            <div class="poster-inner">
                                ...
                                <div class="poster-degree-sub">Bachelor of (Hons.) in<br>
                                    <strong>Cyber Security</strong></div>

                                <div class="poster-why-box">
                                    <div class="pwb-title">Discover <span>BCS</span><br>
                                        at Texas</div>
                                ...
                                <div class="poster-student">
                                    <svg viewBox="0 0 160 270" fill="none" xmlns="http://www.w3.org/2000/svg" width="155" height="270">
                                        ...
                                        <!-- shield in hand -->
                                        <path d="M134 188 Q134 174 144 170 Q154 174 154 188 Q154 202 144 207 Q134 202 134 188Z" fill="#0B1F66" stroke="#FF2D8D" stroke-width="1.5" />
                                        <rect x="139" y="186" width="10" height="8" rx="1.5" fill="#F5C542" />
                                        <path d="M140 186 Q140 181 144 181 Q148 181 148 186" stroke="#F5C542" stroke-width="1.5" fill="none" />
...
const semesterData = [
    ...
    { label: "Second Sem", icon: "2️⃣", subjects: ["Data Structures", "OOP (Java)", "Calculus", "Statistics", "Intro to Cybersecurity"] },
    { label: "Third Sem", icon: "3️⃣", subjects: ["DBMS", "Computer Networks", "OS Security", "Web Security", "Cryptography"] },
    { label: "Fourth Sem", icon: "4️⃣", subjects: ["Network Security", "Ethical Hacking", "Digital Forensics", "Malware Analysis", "Risk Management"] },
    { label: "Fifth Sem", icon: "5️⃣", subjects: ["Penetration Testing", "Cloud Security", "Mobile Security", "Incident Response", "Security Auditing"] },
    { label: "Sixth Sem", icon: "6️⃣", subjects: ["Advanced Forensics", "Threat Intelligence", "IoT Security", "Secure DevOps", "Research Methods"] },
