...
{
    public partial class data_communication_networking: System.Web.UI.Page
    {
        ...
        protected void DownloadFile(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string query = "SELECT Name, Data, ContentType FROM bcs_acn WHERE Id = @Id";
        ...
        private void BindGrid()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    string query = "SELECT Id, Topic, Name FROM bcs_acn";
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        con.Open();
