...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_gsuqn1st {
        ...
        private FastObjectFactory_app_web_gsuqn1st() {
        }
        
        static object Create_ASP_mcs_notes_note_master() {
            return new ASP.mcs_notes_note_master();
        }
    }
}
