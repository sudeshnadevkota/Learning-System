...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_mkv0v2mf {
        ...
        private FastObjectFactory_app_web_mkv0v2mf() {
        }
        
        static object Create_ASP_bit_admin_upload_master() {
            return new ASP.bit_admin_upload_master();
        }
    }
}
