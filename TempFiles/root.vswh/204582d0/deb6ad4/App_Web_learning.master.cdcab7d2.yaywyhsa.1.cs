...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_learning_master_cdcab7d2_yaywyhsa {
        ...
        private FastObjectFactory_app_web_learning_master_cdcab7d2_yaywyhsa() {
        }
        
        static object Create_ASP_learning_master() {
            return new ASP.learning_master();
        }
    }
}
