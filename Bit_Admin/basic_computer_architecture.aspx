<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="basic_computer_architecture.aspx.cs" Inherits="Learning_System.Bit_Admin.basic_computer_architecture" %>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Central Processing Unit)"></asp:TextBox>
