<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="leadership_and_human_relations.aspx.cs" Inherits="Learning_System.Bit_Admin.leadership_and_human_relations" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-users-group"></i> Course Content Management: Leadership and Human Relations</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Transformational Leadership & Strategic Conflict Resolution)"></asp:TextBox>
