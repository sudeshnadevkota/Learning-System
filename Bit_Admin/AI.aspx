<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="AI.aspx.cs" Inherits="Learning_System.Bit_Admin.AI" %>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Deep Neural Networks & Heuristic Search Algorithms)"></asp:TextBox>
