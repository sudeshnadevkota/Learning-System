<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="cloud_computing.aspx.cs" Inherits="Learning_System.Bit_Admin.cloud_computing" %>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Virtualization Architectures & Microservices Deployment)"></asp:TextBox>
