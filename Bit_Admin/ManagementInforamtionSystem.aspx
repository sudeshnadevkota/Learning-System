<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="ManagementInforamtionSystem.aspx.cs" Inherits="Learning_System.Bit_Admin.ManagementInforamtionSystem" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-device-analytics"></i> Course Content Management: Management Information System</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Enterprise Resource Planning & Decision Support Topologies)"></asp:TextBox>
