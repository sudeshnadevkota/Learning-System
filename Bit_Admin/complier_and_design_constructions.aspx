<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="complier_and_design_constructions.aspx.cs" Inherits="Learning_System.Bit_Admin.complier_and_design_constructions" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-binary-tree"></i> Course Content Management: Compiler & Design Construction</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Lexical Analysis & LR Parsing Tables)"></asp:TextBox>
