<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="cyber_security_law_and_policy.aspx.cs" Inherits="Learning_System.Bit_Admin.cyber_security_law_and_policy" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-shield-lock"></i> Course Content Management: Cyber Security Law and Policy</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., GDPR Compliance Frameworks & Digital Forensics Law)"></asp:TextBox>
