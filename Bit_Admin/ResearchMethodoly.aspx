<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="ResearchMethodoly.aspx.cs" Inherits="Learning_System.Bit_Admin.ResearchMethodoly" %>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Quantitative Design Frameworks & Literature Matrix Synthesis)"></asp:TextBox>
