<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="project_work.aspx.cs" Inherits="Learning_System.Bit_Admin.project_work" %>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Project Proposal Guidelines & Milestone Documentation)"></asp:TextBox>
