<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="industrial_training.aspx.cs" Inherits="Learning_System.Bit_Admin.industrial_training" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-briefcase"></i> Course Content Management: Industrial Training</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Internship Logbook Submissions & Weekly Progress Evaluation Layouts)"></asp:TextBox>
