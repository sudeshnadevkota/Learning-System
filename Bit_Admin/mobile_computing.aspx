<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="mobile_computing.aspx.cs" Inherits="Learning_System.Bit_Admin.mobile_computing" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-device-mobile-message"></i> Course Content Management: Mobile Computing</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Cellular Handover Schemes & 5G Core Architectures)"></asp:TextBox>
