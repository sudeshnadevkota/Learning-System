<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="discrete_mathematics.aspx.cs" Inherits="Learning_System.Bit_Admin.discrete_mathematics" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-hierarchy-2"></i> Course Content Management: Discrete Mathematics</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Graph Theory & Set Proposition)"></asp:TextBox>
