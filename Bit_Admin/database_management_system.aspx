<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="database_management_system.aspx.cs" Inherits="Learning_System.Bit_Admin.database_management_system" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-database"></i> Course Content Management: Database Management System</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Relational Algebra & Normalization Forms)"></asp:TextBox>
