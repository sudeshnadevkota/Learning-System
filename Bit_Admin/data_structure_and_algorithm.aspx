<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="data_structure_and_algorithm.aspx.cs" Inherits="Learning_System.Bit_Admin.data_structure_and_algorithm" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-sitemap"></i> Course Content Management: Data Structures & Algorithms</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., AVL Tree Traversal & Dynamic Programming)"></asp:TextBox>
