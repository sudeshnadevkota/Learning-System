<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="system_analysis_and_design.aspx.cs" Inherits="Learning_System.Bit_Admin.system_analysis_and_design" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-git-fork"></i> Course Content Management: System Analysis and Design</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., SDLC Methodologies & Object-Oriented Analysis Systems)"></asp:TextBox>
