<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="SystemSoftware_Administration.aspx.cs" Inherits="Learning_System.Bit_Admin.SystemSoftware_Administration" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-settings-automation"></i> Course Content Management: System Software & Administration</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Kernel Architectures, Shell Scripting & User Authentication Systems)"></asp:TextBox>
