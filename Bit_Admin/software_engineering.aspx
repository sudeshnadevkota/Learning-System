<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="software_engineering.aspx.cs" Inherits="Learning_System.Bit_Admin.software_engineering" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-code-circle"></i> Course Content Management: Software Engineering</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Agile Scrum Framework & CI/CD Deployment Pipelines)"></asp:TextBox>
