<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="multimedia_system.aspx.cs" Inherits="Learning_System.Bit_Admin.multimedia_system" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-video-frame"></i> Course Content Management: Multimedia System</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., MPEG-4 Video Compression & Digital Audio Sampling Rates)"></asp:TextBox>
