...
<div class="d-wrap container-fluid" style="padding: 1.5rem;">
    ...
    <%-- SYSTEM METRICS PANEL (REPLACED QUICK ACCESS) --%>
    <div class="d-section">System Overview</div>
    <div class="d-metrics-panel">
        <div class="d-metric-box">
            <div class="d-metric-icon-wrap m-pink"><i class="ti ti-cloud-upload"></i></div>
            <div class="d-metric-info">
                <span class="d-metric-title">Total Resources</span>
                <span class="d-metric-count">1,240+</span>
            </div>
        </div>
        <div class="d-metric-box">
            <div class="d-metric-icon-wrap m-blue"><i class="ti ti-users-group"></i></div>
            <div class="d-metric-info">
                <span class="d-metric-title">Enrolled Students</span>
                <span class="d-metric-count">3,850</span>
            </div>
        </div>
        <div class="d-metric-box">
            <div class="d-metric-icon-wrap m-yellow"><i class="ti ti-activity"></i></div>
            <div class="d-metric-info">
                <span class="d-metric-title">Server Storage</span>
                <span class="d-metric-count">45.2 GB Used</span>
            </div>
        </div>
    </div>
