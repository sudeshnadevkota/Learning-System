<%@ Page Title="" Language="C#" MasterPageFile="~/Bit_Admin/upload.Master" AutoEventWireup="true" CodeBehind="software_project_management.aspx.cs" Inherits="Learning_System.Bit_Admin.software_project_management" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-microscope"></i> Course Content Management: Research Methodology</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic name (e.g., Quantitative Sampling Techniques & Empirical Study Layouts)"></asp:TextBox>
