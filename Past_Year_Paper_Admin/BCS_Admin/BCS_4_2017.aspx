<%@ Page Title="" Language="C#" MasterPageFile="~/Past_Year_Paper_Admin/BCS_Admin/Upload.Master" AutoEventWireup="true" CodeBehind="BCS_4_2017.aspx.cs" Inherits="Learning_System.Past_Year_Paper_Admin.BCS_Admin.BCS_4_2017" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">BCS Fourth Semester 2017</h3>
        <hr />
