<%@ Page Title="" Language="C#" MasterPageFile="~/Past_Year_Paper_Admin/MBA_Admin/Upload.Master" AutoEventWireup="true" CodeBehind="MBA_3_2023.aspx.cs" Inherits="Learning_System.Past_Year_Paper_Admin.MBA_Admin.MBA_3_2023" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">MBA Third  Semester 2023</h3>
        <hr />
