<%@ Page Title="" Language="C#" MasterPageFile="~/Past_Year_Paper_Admin/MCS_Admin/Upload.Master" AutoEventWireup="true" CodeBehind="MCS_3_2020.aspx.cs" Inherits="Learning_System.Past_Year_Paper_Admin.MCS_Admin.MCS_3_2020" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">MCS Third Semester 2020</h3>
        <hr />
