<%@ Page Title="" Language="C#" MasterPageFile="~/Mba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="international_business.aspx.cs" Inherits="Learning_System.Mba_Admin.international_business" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">International Business</h3>
        <hr />
