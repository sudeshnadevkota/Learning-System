<%@ Page Title="" Language="C#" MasterPageFile="~/Mba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="banking_and_insurance.aspx.cs" Inherits="Learning_System.Mba_Admin.banking_and_insurance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
        <h3 style="text-align: center">Banking Insurance</h3>
        <hr />
        ...
        <div class="container">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" CssClass="table table-bordered table-condensed table-responsive table-hover" OnRowDeleting="GridView1_RowDeleting1">
                <Columns>
