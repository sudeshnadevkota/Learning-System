<%@ Page Title="" Language="C#" MasterPageFile="~/Mba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="business_accounting_and_finance.aspx.cs" Inherits="Learning_System.Mba_Admin.business_accounting_and_finance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Business Accounting And Finance</h3>
        <hr />
        ...
        <asp:Button ID="Button1" runat="server" class="btn btn-primary" Text="Submit" Style="float:right; margin-bottom: 10px;" OnClick="Button1_Click"    />
