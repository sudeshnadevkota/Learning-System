<%@ Page Title="" Language="C#" MasterPageFile="~/Mba_Admin/upload.Master" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="Learning_System.Mba_Admin.dash" %>
...
<div class="d-wrap container-fluid" style="padding: 1.5rem;">
    ...
    <div class="d-hero">
        ...
        <h1>Welcome to MBA Upload Section</h1>
        <p class="d-hero-sub">Manage and publish your e-learning content for Business Administration faculty</p>
        <div class="d-hero-stats">
            <div class="d-hstat">
                <span class="d-hstat-val">4</span>
                <span class="d-hstat-label">Semesters</span>
            </div>
            <div class="d-hstat-sep"></div>
            <div class="d-hstat">
                <span class="d-hstat-val">24</span>
    ...
    <div class="d-cards">
        ...
        <div class="d-card card-pink">
            ...
            <div class="d-card-icon">
                <div class="d-card-icon-inner"><i class="ti ti-briefcase"></i></div>
            </div>
            <div class="d-card-kicker">Module 01</div>
            <div class="d-card-title">Elearning Features</div>
            <p class="d-card-text">Manage your primary features and core settings for MBA faculty.</p>
        ...
        <div class="d-card card-blue">
            <div class="d-card-top-bar"></div>
            <div class="d-card-icon">
                <div class="d-card-icon-inner"><i class="ti ti-chart-bar"></i></div>
            </div>
            <div class="d-card-kicker">Module 02</div>
            <div class="d-card-title">Elearning Needs</div>
            <p class="d-card-text">Update daily requirements and student resources for business courses.</p>
            <div class="d-card-foot">
                <a href="#" class="d-go"><i class="ti ti-arrow-right"></i> Go More</a>
                <span class="d-badge-status">Active</span>
            </div>
        ...
        <div class="d-card card-yellow">
            ...
            <p class="d-card-text">This week's highlighted module for MBA students.</p>
            <div class="d-card-foot">
                <a href="#" class="d-go"><i class="ti ti-arrow-right"></i> Go More</a>
                <span class="d-badge-status">Active</span>
            </div>
    ...
    <div class="d-feature">
        ...
        <div class="d-feature-body">
            ...
            <p class="d-feature-text">
                ...
                This is your highlighted module for the week — tailored for MBA students in Business Administration faculty.
            </p>
