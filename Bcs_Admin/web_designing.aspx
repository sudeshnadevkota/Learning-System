<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="web_designing.aspx.cs" Inherits="Learning_System.Bcs_Admin.web_designing" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-palette"></i> Course Content Management: Web Designing</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic (e.g., HTML5 Semantic Layouts, CSS Grid, Responsive Design)..."></asp:TextBox>
