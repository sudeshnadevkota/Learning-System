<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="advance_routing_technology(wan).aspx.cs" Inherits="Learning_System.Bcs_Admin.advance_routing_technology_wan_" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-router"></i> Course Content Management: Advance Routing Technology (WAN)</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter WAN topic (e.g., OSPFv3, BGP Attributes, MPLS Architecture, SD-WAN Architectures)..."></asp:TextBox>
