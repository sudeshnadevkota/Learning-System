<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="advance_switching_tech_and_troubleshoot.aspx.cs" Inherits="Learning_System.Bcs_Admin.advance_switching_tech_and_troubleshoot" %>
...
<style>
    ...
    /* Action Command Field Elements Styles */
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-device-ethernet"></i> Course Content Management: Advance Switching Tech & Troubleshoot</h3>
    </div>

    <%-- PANEL ONE: FULL WIDTH UPLOAD CONTENT PANEL --%>
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter switching topic (e.g., EtherChannel Bundling, MSTP Configuration, VTP Pruning, VLAN Trunking Troubleshoot)..."></asp:TextBox>
    ...
    <%-- PANEL TWO: DATABASE ARCHIVE VIEW --%>
    <div class="c-panel">
        <div class="c-panel-title">
            <i class="ti ti-database" style="font-size: 14px; color: var(--primary)"></i> Uploaded Resource Archive
        </div>
