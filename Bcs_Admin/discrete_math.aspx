<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="discrete_math.aspx.cs" Inherits="Learning_System.Bcs_Admin.discrete_math" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-math-symbols"></i> Course Content Management: Discrete Math</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter mathematical topic (e.g., Graph Theory, Set Logic)..."></asp:TextBox>
