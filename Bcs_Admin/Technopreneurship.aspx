<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="Technopreneurship.aspx.cs" Inherits="Learning_System.Bcs_Admin.Technopreneurship" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-rocket"></i> Course Content Management: Technopreneurship</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter technopreneurship topic (e.g., Lean Canvas, Intellectual Property, Venture Capital, MVP)..."></asp:TextBox>
