<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="SoftwareProjectManagement.aspx.cs" Inherits="Learning_System.Bcs_Admin.SoftwareProjectManagement" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-git-fork"></i> Course Content Management: Software Project Management</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter SPM topic (e.g., COCOMO Estimation, PERT/CPM Charts, Agile Scrum, Risk Management)..."></asp:TextBox>
