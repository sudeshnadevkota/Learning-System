<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="project_work.aspx.cs" Inherits="Learning_System.Bcs_Admin.project_work" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-presentation"></i> Course Content Management: Project Work</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter project milestone (e.g., Synopsis Submission, Mid-Term Report, Final Documentation, Source Code Archive)..."></asp:TextBox>
