<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="cryptography.aspx.cs" Inherits="Learning_System.Bcs_Admin.cryptography" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-key"></i> Course Content Management: Cryptography</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter cryptographic topic (e.g., AES Encryption, RSA Key Exchange, Hashing, Digital Signatures)..."></asp:TextBox>
