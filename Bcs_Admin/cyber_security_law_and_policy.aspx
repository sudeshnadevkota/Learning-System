<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="cyber_security_law_and_policy.aspx.cs" Inherits="Learning_System.Bcs_Admin.cyber_security_law_and_policy" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-gavel"></i> Course Content Management: Cyber Security Law and Policy</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter regulatory topic (e.g., GDPR, IT Act, Compliance Standards)..."></asp:TextBox>
