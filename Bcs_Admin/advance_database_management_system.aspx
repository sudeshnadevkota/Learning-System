<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="advance_database_management_system.aspx.cs" Inherits="Learning_System.Bcs_Admin.advance_database_management_system" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">Advance Database Management System</h3>
        <hr />
      ...
      <div class="container">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" class="table table-bordered table-condensed table-responsive table-hover" OnRowDeleting="GridView1_RowDeleting1">          <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" ControlStyle-ForeColor="Red" ButtonType="Button" />
            </Columns>
