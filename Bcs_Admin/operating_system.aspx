<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="operating_system.aspx.cs" Inherits="Learning_System.Bcs_Admin.operating_system" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-terminal-2"></i> Course Content Management: Operating System</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter OS topic (e.g., Process Scheduling, Memory Management)..."></asp:TextBox>
