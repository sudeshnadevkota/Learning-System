<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="database_management_system.aspx.cs" Inherits="Learning_System.Bcs_Admin.database_management_system" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-database-cog"></i> Course Content Management: Database Management System</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter DBMS topic (e.g., ER-Diagrams, Normalization, SQL Queries, Joins)..."></asp:TextBox>
