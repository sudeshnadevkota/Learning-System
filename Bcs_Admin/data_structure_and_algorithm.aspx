<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="data_structure_and_algorithm.aspx.cs" Inherits="Learning_System.Bcs_Admin.data_structure_and_algorithm" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-sitemap"></i> Course Content Management: Data Structure & Algorithm</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter DSA topic (e.g., AVL Trees, Dynamic Programming, Graphs, Sorting Algorithms)..."></asp:TextBox>
