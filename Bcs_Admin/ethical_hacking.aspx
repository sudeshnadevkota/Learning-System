<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="ethical_hacking.aspx.cs" Inherits="Learning_System.Bcs_Admin.ethical_hacking" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-shield-lock"></i> Course Content Management: Ethical Hacking</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter hacking topic (e.g., Reconnaissance, SQL Injection, Wireshark Analysis)..."></asp:TextBox>
