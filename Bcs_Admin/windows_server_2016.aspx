<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="windows_server_2016.aspx.cs" Inherits="Learning_System.Bcs_Admin.windows_server_2016" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-server-bolt"></i> Course Content Management: Windows Server 2016</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter configuration topic (e.g., Active Directory, Group Policy, Nano Server)..."></asp:TextBox>
