<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="LSHR.aspx.cs" Inherits="Learning_System.Bcs_Admin.LSHR" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-users"></i> Course Content Management: Leadership & Human Relations</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter topic (e.g., Conflict Management, Motivation Theories, Group Dynamics, Interpersonal Skills)..."></asp:TextBox>
