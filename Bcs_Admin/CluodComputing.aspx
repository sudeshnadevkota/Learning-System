<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="CluodComputing.aspx.cs" Inherits="Learning_System.Bcs_Admin.CluodComputing" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-cloud-computing"></i> Course Content Management: Cloud Computing</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter cloud topic (e.g., Virtualization Techniques, SaaS/PaaS/IaaS Models, AWS Infrastructure, Serverless Architectures)..."></asp:TextBox>
