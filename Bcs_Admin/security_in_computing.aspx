<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="security_in_computing.aspx.cs" Inherits="Learning_System.Bcs_Admin.security_in_computing" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-shield-lock"></i> Course Content Management: Security in Computing</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter security topic (e.g., Cryptography, Firewalls)..."></asp:TextBox>
