<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="basic_computer_architecture.aspx.cs" Inherits="Learning_System.Bcs_Admin.basic_computer_architecture" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-cpu"></i> Course Content Management: Basic Computer Architecture</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter architecture topic (e.g., CPU Registers, Von Neumann)..."></asp:TextBox>
