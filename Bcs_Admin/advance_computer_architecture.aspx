<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="advance_computer_architecture.aspx.cs" Inherits="Learning_System.Bcs_Admin.advance_computer_architecture" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-cpu-charge"></i> Course Content Management: Advance Computer Architecture</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter advanced topic (e.g., Pipelining, Instruction-Level Parallelism)..."></asp:TextBox>
