<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="industrial_training.aspx.cs" Inherits="Learning_System.Bcs_Admin.industrial_training" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-building-factory-2"></i> Course Content Management: Industrial Training</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter training milestone (e.g., Internship Offer Letter, Weekly Logbook, Evaluation Criteria, Final Placement Report)..."></asp:TextBox>
