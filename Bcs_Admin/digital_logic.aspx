<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="digital_logic.aspx.cs" Inherits="Learning_System.Bcs_Admin.digital_logic" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-binary-tree"></i> Course Content Management: Digital Logic</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter logic topic (e.g., K-Maps, Logic Gates, Sequential Circuits)..."></asp:TextBox>
