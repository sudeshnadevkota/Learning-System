<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="e_commerce.aspx.cs" Inherits="Learning_System.Bcs_Admin.e_commerce" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-shopping-cart-discount"></i> Course Content Management: E-Commerce</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter e-commerce topic (e.g., Payment Gateways, Supply Chain, B2B Models)..."></asp:TextBox>
