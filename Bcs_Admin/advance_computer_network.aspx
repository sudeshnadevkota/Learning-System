<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="advance_computer_network.aspx.cs" Inherits="Learning_System.Bcs_Admin.advance_computer_network" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-router"></i> Course Content Management: Advance Computer Network</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter advanced topic (e.g., BGP Routing, SDN, IPv6 Transition)..."></asp:TextBox>
