<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="industrial_management.aspx.cs" Inherits="Learning_System.Bcs_Admin.industrial_management" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-building-factory-2"></i> Course Content Management: Industrial Management</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter industrial management topic (e.g., Plant Layout, Inventory Control, Operations Research, Six Sigma)..."></asp:TextBox>
