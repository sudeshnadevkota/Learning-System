<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="system_software_administration.aspx.cs" Inherits="Learning_System.Bcs_Admin.system_software_administration" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-terminal-2"></i> Course Content Management: System Software Administration</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter systems administration topic (e.g., Kernel Compiling, User/Group Quotas, Shell Scripting, Network File Systems)..."></asp:TextBox>
