<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="wireless_communications.aspx.cs" Inherits="Learning_System.Bcs_Admin.wireless_communications" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-antenna"></i> Course Content Management: Wireless Communication</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter wireless topic (e.g., Multiplexing, Cellular Architecture, 5G Standards)..."></asp:TextBox>
