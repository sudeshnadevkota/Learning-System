<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="Information_Security_Management.aspx.cs" Inherits="Learning_System.Bcs_Admin.Information_Security_Management" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-shield-lock"></i> Course Content Management: Information Security Management</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter security topic (e.g., Risk Assessment, ISO 27001, Access Control Policies, Business Continuity)..."></asp:TextBox>
