<%@ Page Title="" Language="C#" MasterPageFile="~/Bcs_Admin/upload.Master" AutoEventWireup="true" CodeBehind="AI.aspx.cs" Inherits="Learning_System.Bcs_Admin.AI" %>
...
<div class="c-wrap container-fluid">
    ...
    <div class="c-hero">
        ...
        <h3><i class="ti ti-brain"></i> Course Content Management: Artificial Intelligence</h3>
    </div>
    ...
    <div class="c-panel">
        ...
        <div class="c-form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter AI topic (e.g., Neural Networks, Search Algorithms, NLP, Computer Vision)..."></asp:TextBox>
